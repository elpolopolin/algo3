...
> Fuente única: `algoritmos-con-grafos.md` y la carpeta `temas/`.
...
![Capas L0, L1, L2, L3](imagenes-claude/00-capas.png)
...
![Los tres estados: blanco, gris, negro](imagenes-claude/01-colores.png)
...
notaciones:
V[G] = conjunto de vertices(nodos) del grafo G
G = (V,E) grafo G definido por conjunto de vertices V y conjunto de aristas E. 
d[u] distania a u
```
Función BFS(G, s)
...
![La cola paso a paso](imagenes-claude/02-cola-pasos.png)
...
![Lema de la cola](imagenes-claude/04-lema-cola.png)
...
![Árbol BFS](imagenes-claude/03-arbol-bfs.png)
